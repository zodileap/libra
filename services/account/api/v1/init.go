...
func init() {
	zapi.Register("libra_account", "auth", "v1", &AuthAPI{})
	zapi.Register("libra_account", "agent-access", "v1", &AgentAccessAPI{})
	zapi.Register("libra_account", "agent", "v1", &AgentAPI{})
	zapi.Register("libra_account", "user", "v1", &UserAPI{})
}
