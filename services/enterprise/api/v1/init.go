...
func init() {
	zapi.Register("enterprise", "enterprise-role", "v1", &EnterpriseRoleAPI{})
	zapi.Register("enterprise", "enterprise-member", "v1", &EnterpriseMemberAPI{})
	zapi.Register("enterprise", "enterprise", "v1", &EnterpriseAPI{})
}
