      ...
      graph: {
        nodes: [
          ...
          },
          {
            ...
            description: translateDesktopText("整理前后端交互模型并同步 Apifox"),
            instruction: translateDesktopText("先定义实体、请求模型、响应模型，再通过 Apifox 官方 MCP Server（npx -y apifox-mcp-server@latest）同步到 Apifox。"),
            type: "skill",
        ...
        edges: [
          ...
          {
            id: "wf-agent-full-delivery-edge-apifox-model-frontend-structure",
