...
export const AGENT_TOOLSET_LINES: string[] = [
  ...
  "- 联网与外部：web_search、fetch_url、mcp_tool、dcc_tool、tool_search",
  "",
  ...
  "- 跨软件迁移先调用：dcc_tool(\"cross_dcc.transfer\", \"plan_transfer\", {\"preferred_format\":\"fbx\"}, source_software=\"blender\", target_software=\"maya\")",
