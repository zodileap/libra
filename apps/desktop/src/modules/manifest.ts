...
export const DESKTOP_ROUTE_MODULE_MANIFEST: Array<{
  ...
  { key: "settings", title: translateDesktopText("设置") },
  { key: "skill", title: translateDesktopText("技能") },
  { key: "mcp", title: "MCP" },
  { key: "agent", title: translateDesktopText("智能体") },
  { key: "session", title: translateDesktopText("会话") },
  { key: "workflow", title: translateDesktopText("工作流") },
];
