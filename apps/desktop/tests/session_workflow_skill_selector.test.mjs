...
test("TestSessionPageShouldProvideWorkflowAndSkillSelectorModal", () => {
  ...
  assert.match(sessionSource, /finishAssistantRunMessage\(\s*streamMessageId,\s*"finished",\s*buildWorkflowCompletionSummary\(/s);
  ...
  assert.match(sessionSource, /return renderRunSegmentBodyContent\(segment\.text, runningClass\);/);
  ...
  assert.match(sessionSource, /className=\{detailToggleClassName\}/);
  ...
  assert.match(sessionSource, /const shouldUseRichStaticStepShell = Boolean\(richMeta\);/);
  assert.match(sessionSource, /const detailToggleClassName = shouldUseRichStaticStepShell/);
  assert.match(sessionSource, /className="desk-run-segment-static-step-rich"/);
  assert.match(sessionSource, /className="desk-run-segment-detail-toggle-content"/);
  ...
  assert.match(sessionSource, /className="desk-run-step-suffix"/);
  ...
  assert.match(styleSource, /\.desk-run-step-body \{[\s\S]*font-size:\s*var\(--z-font-size-sm\);[\s\S]*color:\s*var\(--desk-run-text-primary\);/);
  ...
  assert.match(styleSource, /\.desk-run-segment-detail-toggle-rich \{[\s\S]*padding:\s*0;/);
  assert.match(styleSource, /\.desk-run-segment-static-step \{[\s\S]*font:\s*inherit;/);
  assert.match(styleSource, /\.desk-run-segment-static-step-rich \{[\s\S]*padding:\s*0;/);
  assert.match(styleSource, /\.desk-run-segment-static-step-rich \{[\s\S]*display:\s*flex;/);
