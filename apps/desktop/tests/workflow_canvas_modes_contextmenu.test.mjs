...
test("TestWorkflowCanvasShouldSupportModeSwitchAndContextDelete", () => {
  ...
  assert.match(source, /icon=\{workflowReadonly \? "folder" : "edit"\}/);
  assert.match(source, /aria-label=\{workflowReadonly \? "查看工作流" : "编辑工作流"\}/);
  assert.match(source, /icon="content_copy"/);
  assert.match(source, /aria-label="复制工作流"/);
  ...
  assert.match(source, /title=\{workflowReadonly \? "查看工作流" : "编辑工作流"\}/);
